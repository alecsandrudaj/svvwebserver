...
public class Response {
    ...
    public Response(String resource, String httpVersion) {
        ...
        this.httpVersion = httpVersion;
        this.contentType = MimeTypes.getMimeType(this.resource);
    ...
    private byte[] getResource(){
        ...
        try {
            if (this.resource.equals("/") || this.resource.isEmpty()) {
                return contentProvider.getDefaultPage();
            }
            try {
                return contentProvider.getByteContent(this.resource);
            } catch (FileNotFoundException e) {
                this.statusCode = StatusCodes.NOT_FOUND;
                return contentProvider.getErrorPage();
            }
        } catch (IOException e) {
            e.printStackTrace();
